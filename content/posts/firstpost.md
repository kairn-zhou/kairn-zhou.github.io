...
title: firstpost
date: 2025-06-04
description: does this description stuff even do anything bro
categories: notetag
---
...
Backlinks
See related tips in {{< backlink "secondpost" "Text Formatting Basics" >}} and check
out {{< backlink "firstnote" >}} for more on Markdown in documentation.

Check out the [Graph page]({{< relref "/graph" >}}) to see an example of what a larger graph looks like.
Check out the {{< backlink "secondpost" "graph but backlinked instead" >}} to see an example of what a larger graph looks like.
